...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      {/* Футер */}
      <footer className="relative z-10 py-4 sm:py-8 mt-4 sm:mt-8 border-t border-white/10">
        <div className="container mx-auto px-3 sm:px-4 text-center text-[#a8d8ea]/60 text-xs sm:text-sm">
